    ...
    internal class OnUpdateEvents : Logic
    {
        internal static void Init()
        {
            ...
            Game.OnUpdate += Args =>
            {
                ...
                else if (Orbwalker.GetTarget().IsValidTarget() && Orbwalker.GetTarget() is Obj_AI_Hero)
                {
                    myTarget = (Obj_AI_Hero) Orbwalker.GetTarget();
                }
                else
                {
                    myTarget = null;
        ...
        private static void ShyBurst(Obj_AI_Hero target)
        {
            ...
            if (target.IsValidTarget(E.Range + Me.AttackRange + Me.BoundingRadius))
            {
                ...
                {
                    E.Cast(target.Position, true);
                    Utility.DelayAction.Add(10 + Game.Ping, () => R.Cast(true));
                    Utility.DelayAction.Add(60 + Game.Ping, () => W.Cast(true));
                    return;
                }
            ...
            //        E.Cast(target.Position, true);
            //        Utility.DelayAction.Add(10 + Game.Ping, () => R.Cast(true));
            //        Utility.DelayAction.Add(60 + Game.Ping, () => Q.Cast(target.Position, true));
            //        Utility.DelayAction.Add(65 + Game.Ping, () => W.Cast(true));
            //        return;
            //    }
            ...
            else if (MenuInit.BurstFlash && FlashSlot != SpellSlot.Unknown && Flash.IsReady())
            {
                if (target.IsValidTarget(E.Range + Me.AttackRange + Me.BoundingRadius + Flash.Range))
                {
                    if (E.IsReady() && R.IsReady() && W.IsReady() && !isRActive)
                    {
                        ...
                        Utility.DelayAction.Add(10 + Game.Ping, () => R.Cast(true));
                        Utility.DelayAction.Add(60 + Game.Ping, () => W.Cast(true));
                        Utility.DelayAction.Add(61 + Game.Ping, () => Flash.Cast(target.Position, true));
                        return;
                    }
                    ...
                    if (E.IsReady() && R.IsReady() && !isRActive)
                    {
                        E.Cast(target.Position, true);
                        Utility.DelayAction.Add(10 + Game.Ping, () => R.Cast(true));
                        Utility.DelayAction.Add(60 + Game.Ping, () => Flash.Cast(target.Position, true));
                    }
                }
                ...
                //        Utility.DelayAction.Add(10 + Game.Ping, () => R.Cast(true));
                //        Utility.DelayAction.Add(60 + Game.Ping, () => Q.Cast(target.Position, true));
                //        Utility.DelayAction.Add(80 + Game.Ping, () => W.Cast(true));
                //        Utility.DelayAction.Add(81 + Game.Ping, () => Flash.Cast(target.Position, true));
                //        return;
                //    }
                ...
                //        Utility.DelayAction.Add(10 + Game.Ping, () => R.Cast(true));
                //        Utility.DelayAction.Add(60 + Game.Ping, () => Q.Cast(target.Position, true));
                //        Utility.DelayAction.Add(80 + Game.Ping, () => Flash.Cast(target.Position, true));
                //    }
                //}
            }
        }

        private static void EQFlashBurst(Obj_AI_Hero target)
        {
            if (MenuInit.BurstDot && IgniteSlot != SpellSlot.Unknown && Ignite.IsReady() &&
                Ignite.Cast(target, true) == Spell.CastStates.SuccessfullyCasted)
            {
            ...
            if (MenuInit.BurstFlash && FlashSlot != SpellSlot.Unknown && Flash.IsReady())
            {
                    ...
                    target.IsValidTarget(E.Range + Flash.Range + Q.Range - 100))
                {
                    E.Cast(target.Position, true);
                    Utility.DelayAction.Add(10 + Game.Ping, () => R.Cast(true));
                    Utility.DelayAction.Add(50 + Game.Ping, () => Flash.Cast(target.Position, true));
                    Utility.DelayAction.Add(61 + Game.Ping, () => Riven.UseItem());
                    Utility.DelayAction.Add(62 + Game.Ping, () => Q.Cast(target.Position, true));
                    Utility.DelayAction.Add(70 + Game.Ping, () => W.Cast(true));
                    Utility.DelayAction.Add(71 + Game.Ping, () => R.Cast(target.Position, true));
                }
            }
            else if (target.IsValidTarget(E.Range + Q.Range + Q.Range +Q.Range))
            {
                    ...
                    target.IsValidTarget(E.Range + Q.Range - 100))
                {
                    E.Cast(target.Position, true);
                    Utility.DelayAction.Add(10 + Game.Ping, () => R.Cast(true));
                    Utility.DelayAction.Add(50 + Game.Ping, () => Q.Cast(target.Position, true));
                    Utility.DelayAction.Add(61 + Game.Ping, () => Riven.UseItem());
                    Utility.DelayAction.Add(62 + Game.Ping, () => W.Cast(true));
                    Utility.DelayAction.Add(70 + Game.Ping, () => R.Cast(target.Position, true));
                }
            }
        }
